-- [1] FIND THE TOTAL NUMBERS OF RECORDS IN THE PRODUCT TABLE
SELECT COUNT(*) AS CNT
FROM product;
...
-- [3] FETCH TOTAL NUMBER OF MALE AND FEMALE CUSTOMERS - (USE ONLINE_CUSTOMERS TABLE)
